...
public func applyBitrate(requestedBitrate: Int?, targetWidth: Int? = nil, targetHeight: Int? = nil, presetHint: String? = nil, preferH264: Bool = false) -> String {
    if let bitrate = requestedBitrate {
        ...
        if bitrate >= 50_000_000 {
            ...
            // Prefer a 1080p preset when the target render size is >= 1280x720
